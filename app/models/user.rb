class User < ActiveRecord::Base
  ...
  has_many :relationships, foreign_key: "follower_id", dependent: :destroy # also handled by foreign key
  has_many :following, through: :relationships, source: :followed

  has_many :reverse_relationships, foreign_key: "followed_id",
                                   class_name: "Relationship", dependent: :destroy # also handled by foreign key
