...
require [
...
], (_, $, base58, Indian, Key, App, Post, User, Constants, Titlecard) ->
  ...
  Key 'shift+alt+c', _.once -> require ['etc/clippy'], (clippy) ->
    window.clippy = clippy
    $("<link>", {rel: "stylesheet", href: "/assets/etc/clippy.css"}).appendTo("head")
    clippy.load 'Clippy', (agent) ->
      agent.show()
      agent.animate()
      setInterval (-> agent.animate()), 15000
