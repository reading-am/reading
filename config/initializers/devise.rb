...
Devise.setup do |config|
  ...
  config.mailer_sender = "Greg <greg@#{ROOT_DOMAIN}>"
  ...
  # config.pepper = "34923e7ec2a454ed85851f4907dd621d4aafc62d0f7ad4085737698759dae6f23b57ac1f0a65e49e45009e70a54bd68e17cb5e67074a99261e542e6aaf358d95"
  ...
  config.omniauth :slack,       ENV["SLACK_KEY"],       ENV["SLACK_SECRET"], scope: ['channels:read', 'chat:write:bot']
