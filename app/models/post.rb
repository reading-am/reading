class Post < ActiveRecord::Base
  ...
  has_many        :comments #, dependent: :nullify # handled by foreign key # intentionally not dependent destroy here, have it on pages and users
  has_many        :referring_posts, class_name: 'Post',
                                    foreign_key: 'referrer_post_id' #, dependent: :nullify # handled by the foreign key
